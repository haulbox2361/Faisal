  ...
  try {
    ...
    if (serviceAccountJson) {
      ...
      try {
        ...
        console.warn('[FCM] firebase-admin package not installed. Push notifications will use Socket.IO real-time delivery.');
        return null;
      }
      ...
      console.log('[FCM] Note: FIREBASE_SERVICE_ACCOUNT not configured. Real-time push handled via Socket.IO & In-App Notification Center.');
    }
  } catch (e) {
