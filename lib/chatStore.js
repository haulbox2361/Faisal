...
async function sendMessage(conversationId, sender, body, loadId = null, loadNumber = null) {
  await ensureSchema();
  const { rows } = await getPool().query(
    `INSERT INTO messages (conversation_id, sender_type, sender_id, sender_name, body, load_id, load_number)
     VALUES ($1, $2, $3, $4, $5, $6, $7)
     RETURNING id, created_at`,
    [conversationId, sender.type, sender.id, sender.name || null, body, loadId || null, loadNumber || null]
  );
